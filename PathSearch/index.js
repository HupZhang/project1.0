/**
 * Created by Valora on 2018/7/21.
 */
// helpers
...
app.end = function (win) {
    ...
    if (win) {
        app.launchScreen(
            app.score.number,
            "Well Done!",
            "Your score: " + sessionStorage.getItem("results") + '. The next level will be more difficult.',
        ...
        app.launchScreen(
            0,
            "Game over!",
            "Your final score: " + sessionStorage.getItem("results") +".",
            "Play again."
        );
        app.results("reset");
        app.score.reset();
